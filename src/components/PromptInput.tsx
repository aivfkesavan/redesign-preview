...
const PromptInput = () => {
  return (
    <div className="w-full max-w-2xl mx-auto mt-8 mb-10 animate-slide-up">
      <div className="relative bg-[#221F26] rounded-lg border border-[#33C3F0]/20 overflow-hidden shadow-lg">
        <Textarea
        ...
        />
        <div className="p-3 border-t border-[#33C3F0]/20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" className="bg-[#1A1F2C] border-[#33C3F0]/20 text-white/80 hover:bg-[#8B5CF6]/20 text-sm">
              Public
            </Button>
            <Button size="sm" className="bg-gradient-to-r from-[#8B5CF6] to-[#F97316] hover:opacity-90 text-white">
